<template>
  <div class="container mx-auto w-11/12 lg:w-10/12 justify-center mb-40">
    <div class="mt-24">
      ...
      <p>
        By accessing this Website, accessible from https://hyp.lucapirovano.com/, you are agreeing to be bound by these
      ...
      <p>
        This will let Amogus to terminate upon violations of any of these restrictions. Upon termination, your viewing
      ...
      <p>
        All the materials on Amogus’s Website are provided "as is". Amogus makes no warranties, may it be expressed or
        implied, therefore negates all other warranties. Furthermore, Amogus does not make any representations
      ...
      <p>
        Amogus or its suppliers will not be hold accountable for any damages that will arise with the use or inability
        to use the materials on Amogus’s Website, even if Amogus or an authorize representative of this Website has been
        notified, orally or written, of the possibility of such damage. Some jurisdiction does not allow limitations on
        implied warranties or limitations of liability for incidental damages, these limitations may not apply to
        you.
      </p>
      ...
      <p>
        The materials appearing on Amogus’s Website may include technical, typographical, or photographic errors.
        Amogus will not promise that any of the materials in this Website are accurate, complete, or current. Amogus may
        change the materials contained on its Website at any time without notice. Amogus does not make any commitment to
      ...
      <p>
        Amogus has not reviewed all of the sites linked to its Website and is not responsible for the contents of any
        such linked site. The presence of any link does not imply endorsement by Amogus of the site. The use of any
      ...
      <p>
        Amogus may revise these Terms of Use for its Website at any time without prior notice. By using this Website,
        you are agreeing to be bound by the current version of these Terms and Conditions of Use.
      </p>

      <h3>8. Your Privacy</h3>

      <p>Please read our <a href="#privacy-section">Privacy Policy.</a></p>

      <h3>9. Governing Law</h3>

      <p>
        Any claim related to Amogus's Website shall be governed by the laws of it without regards to its conflict of
        law provisions.
      </p>
      <h2 id="privacy-section">
        Privacy Policy
      </h2>

      <p>
        At Amsterdam Amogus, accessible from https://hyp.lucapirovano.com, one of our main priorities is the privacy of
        our visitors. This Privacy Policy document contains types of information that is collected and recorded by
        Amsterdam Amogus and how we use it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in Amsterdam Amogus. This policy is not applicable to any
        information collected offline or via channels other than this website. Our Privacy Policy was created with the
        help of the <a href="https://www.termsfeed.com/privacy-policy-generator/">Free Privacy Policy Generator</a>.
      </p>
      ...
      <p>
        Amsterdam Amogus follows a standard procedure of using log files. These files log visitors when they visit
      ...
      <p>
        Like any other website, Amsterdam Amogus uses 'cookies'. These cookies are used to store information including
      ...
      <P>
        You may consult this list to find the Privacy Policy for each of the advertising partners of Amsterdam
        Amogus.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Amsterdam Amogus, which are sent directly to users'
      ...
      <p>
        Note that Amsterdam Amogus has no access to or control over these cookies that are used by third-party
        advertisers.
      </p>
      ...
      <p>
        Amsterdam Amogus's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      <p>
        Amsterdam Amogus does not knowingly collect any Personal Identifiable Information from children under the age
